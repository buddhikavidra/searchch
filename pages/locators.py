...
class PageLocators():
    ...
    Sector_INPUT = (By.XPATH, '//input[@id="tel-form-extended-misc"]')
    Street_INPUT = (By.XPATH, '//input[@id="tel-form-extended-strasse"]')
    City_INPUT = (By.XPATH, '//input[@id="tel-form-extended-ort"]')
    Canton_DD =  (By.XPATH, '//select[@id="tel-form-extended-kanton"]')
    Phonenumber_INPUTE = (By.XPATH, '//input[@id="tel-form-extended-tel"]')
    Submit_BUTTON = (By.XPATH, '(//input[@value="Search"])[2]')
    Submit_BUTTONtwo = (By.XPATH, '(//input[@value="Search"])[1]') 
